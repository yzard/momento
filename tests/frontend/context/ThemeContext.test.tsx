...
import {
  ThemeProvider,
} from '../../../src/frontend/context/ThemeContext'
...
beforeEach(() => {
  ...
  vi.stubGlobal('matchMedia', vi.fn(() => ({
    ...
    onchange: null,
    addEventListener: legacyMediaQuery ? undefined : (_type: string, listener: (event: MediaQueryListEvent) => void) => mediaListeners.add(listener),
    removeEventListener: legacyMediaQuery ? undefined : (_type: string, listener: (event: MediaQueryListEvent) => void) => mediaListeners.delete(listener),
    addListener: legacyMediaQuery ? (listener: (event: MediaQueryListEvent) => void) => mediaListeners.add(listener) : vi.fn(),
    removeListener: legacyMediaQuery ? (listener: (event: MediaQueryListEvent) => void) => mediaListeners.delete(listener) : vi.fn(),
    dispatchEvent: vi.fn(),
  })))
})
