...
@Serializable data class BackupCapabilities(val enabled: Boolean, val protocolVersion: Int, val maxUploadBytes: Long, val maxChunkBytes: Long, val sessionExpiryHours: Long)
