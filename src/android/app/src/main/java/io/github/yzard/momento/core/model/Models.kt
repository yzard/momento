...
@Serializable data class TrashMedia(val id: Long, val filename: String, val originalFilename: String, val mediaType: String, val mimeType: String?, val deletedAt: String, val createdAt: String)
