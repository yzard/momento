...
class MomentoRepository(
    ...
    override suspend fun generateMetadata(): MetadataActionResponse = api().generateMetadata(EmptyRequest())
    override suspend fun cancelMetadata(): MetadataActionResponse = api().cancelMetadata(EmptyRequest())
    override suspend fun metadataStatus(): MetadataStatus = api().metadataStatus(EmptyRequest())
    override suspend fun cleanMetadata(): MetadataActionResponse = api().cleanMetadata(EmptyRequest())
