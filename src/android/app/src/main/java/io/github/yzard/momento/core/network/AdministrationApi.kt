...
interface AdministrationApi {
    ...
    @POST("api/v1/metadata/generate") suspend fun generateMetadata(@Body request: EmptyRequest): MetadataActionResponse
    @POST("api/v1/metadata/cancel") suspend fun cancelMetadata(@Body request: EmptyRequest): MetadataActionResponse
    @POST("api/v1/metadata/status") suspend fun metadataStatus(@Body request: EmptyRequest): MetadataStatus
    @POST("api/v1/metadata/clean") suspend fun cleanMetadata(@Body request: EmptyRequest): MetadataActionResponse
