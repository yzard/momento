...
export const aiApi = {
  ...
  triggerScreenshotDetection: async (): Promise<{ message: string; queuedJobs: number }> => (await apiClient.post('/ai/screenshot_detection/trigger', {})).data,
  ...
  triggerDocumentDetection: async (): Promise<{ message: string; queuedJobs: number }> => (await apiClient.post('/ai/document_detection/trigger', {})).data,
