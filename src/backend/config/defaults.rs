...
pub(crate) const WEBDAV_POLL_INTERVAL_SECONDS: u64 = 5;
pub(crate) const WEBDAV_STABLE_FILE_AGE_SECONDS: u64 = 10;
pub(crate) const WEBDAV_MAX_CONCURRENT_PROCESSING: usize = 2;
