...
CREATE TABLE IF NOT EXISTS media (
    ...
    file_size INTEGER,
    content_hash TEXT,
    import_state TEXT NOT NULL DEFAULT 'imported' CHECK(import_state IN ('importing', 'recovering', 'imported', 'failed')),
    import_source_root TEXT,
    import_source_path TEXT,
    import_cleanup_source INTEGER NOT NULL DEFAULT 0,
    import_cleanup_sidecar INTEGER NOT NULL DEFAULT 0,
